...
private Semaphore lock=new Semaphore(1,true);
	...
	public Server2() {
		try {
			System.out.println("Server_2, Usage: java UDPServer <" + socket_no
					+ ">");
			...
			try {
				database.generateCandidates("input/File_2.txt");
			} catch (Exception e) {
	...
	public void sendToClient() {
		try {
			...
			System.out.println("SERVER_2: sendToClient FAILED");
		}
	}
	...
	public  void recieveFromClient() {
		...
		slave.start();
			...
			System.out.println("SERVER_2: recieveFromClient FAILED");
		}
	}
